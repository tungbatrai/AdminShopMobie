...
const LogoutAct = {title: "로그아웃", url: "/login"}
    ...
    return (
        <>
            <nav className="sb-topnav navbar navbar-expand navbar-dark bg-dark" aria-label=''>
                <Link className="navbar-brand" to="/index.html">TMT</Link>
                {!isLogin &&
                <button className="btn btn-link btn-sm order-1 order-lg-0" id="sidebarToggle" onClick={handleToggle}><i
                    ...
                    <li className="nav-item dropdown">
                        <a className="nav-link dropdown-toggle" id="userDropdown" role="button" data-toggle="dropdown"
                           aria-haspopup="true" aria-expanded="false" href="/">
                            <svg className="svg-inline--fa fa-user fa-w-14 fa-fw" aria-hidden="true" focusable="false"
                        ...
                        <div className="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                            <a className="dropdown-item" href={LogoutAct.url}>{LogoutAct.title}</a>
                        </div>
                    </li>
                </ul>
                }
